...
# NAT Gateway in the public-a subnet
resource "aws_nat_gateway" "nat" {
  ...
  # Ensure the IGW exists before NAT GW (good practice)
  depends_on = [aws_internet_gateway.igw]
}

# Collect your private route tables
locals {
...
# Default route in each private RT via the NAT GW
